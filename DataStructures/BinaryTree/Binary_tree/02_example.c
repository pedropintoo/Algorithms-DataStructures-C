...
int main(void) {
  ...
  printf("POST-Order traversal using a STACK: ");

  TreeTraverseInPOSTOrderWithSTACK(tree,printInteger);
  ...
  TreeStoreInFile(tree, "tree1.txt", 1);

  printf("READING from a file\n");

  Tree* treeFromFile = TreeGetFromFile("tree1.txt", 1);
